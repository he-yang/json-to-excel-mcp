...
The Service is API Server or MCP server providing service that allows users to convert JSON files into Excel format. The Service is designed to facilitate the conversion of data from JSON into Excel spreadsheets, which can be used for various applications, including web development, data interchange, and more.
...
- Maintaining the security of your Pro Code and any data processed through the Service.
- Complying with all applicable laws and regulations in your use of the Service.

## 7. Data Privacy

We are committed to protecting your privacy. Your "JSON data" is transmitted securely via HTTPS and processed through our Cloudflare Workers-based Service. For subscription management, we collect and store necessary billing information in accordance with our Privacy Policy. Detailed Privacy Policy, refer to [Privacy Policy](PRIVACY.md)
