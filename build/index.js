...
server.registerTool("json_to_excel_mcp_from_url", {
...
server.registerTool("json_to_excel_mcp_from_data", {
...
server.registerPrompt("from-url", {
...
server.registerPrompt("from-url-upload", {
...
server.registerPrompt("from-data", {
